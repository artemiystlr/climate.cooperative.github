...
This format uses Markdown syntax, which is ideal for GitHub README files. Horizontal lines (created with `---`) provide a clear visual separation between sections, making the document more readable and engaging.
